...
return [
    ...
    'timestamp' => 1544545270,
    'checksum' => '77a5476b4676e89661c23d37ff98ad23',
    'files' => [
    ...
    'data' => [
        ...
        'dynamic' => [
            ...
            'plugins.git-sync.webhook' => [
                'default' => [
                    'action' => 'data',
                    'params' => '\\Grav\\Plugin\\GitSyncPlugin::generateRandomWebhook'
                ]
            ],
            'plugins.git-sync.webhook_secret' => [
                'default' => [
                    'action' => 'data',
                    'params' => '\\Grav\\Plugin\\GitSyncPlugin::generateWebhookSecret'
                ]
            ],
            'plugins.login.user_registration.groups' => [
                'options' => [
